...
angular.module('app', ['ionic', 'ionic.cloud', 'app.controllers', 'app.routes', 'app.directives','app.services', 'luegg.directives', 'monospaced.elastic', 'ngCordova', 'ngFileUpload', 'ngStorage'])
